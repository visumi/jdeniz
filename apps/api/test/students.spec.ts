...
describe("validateStudentInput", () => {
  it("normaliza campos opcionais", () => {
    expect(validateStudentInput({ name: "  Ana Lima ", email: " ana@example.com ", phone: " " })).toEqual({ name: "Ana Lima", email: "ana@example.com", phone: null, credits: 0, attendanceMode: null, birthDate: null, startDate: null, observations: null });
  });
